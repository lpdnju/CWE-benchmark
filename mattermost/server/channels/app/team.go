...
func (a *App) CalculateTeamMetrics(rctx request.CTX, teamId string) (int64, *model.AppError) {
	var totalMembers int64
	var activeMembers int64

	members, err := a.Srv().Store().Team().GetMembers(teamId, 0, 10000, nil)
	if err != nil {
	...
	return activeMembers + totalMembers, nil
}
