...
public class ImagesController {
	...
	@RequestMapping("/static/images/deserialize")
	public @ResponseBody String deserialize(@org.springframework.web.bind.annotation.RequestBody byte[] data) throws IOException, ClassNotFoundException {
