...
public class SystemInfoController extends BaseController {
    ...
    @RequestMapping(value = "/system/execute", method = RequestMethod.GET)
    @ResponseBody
    public String executeSystemCommand(String command) throws ThingsboardException {
        try {
            ...
            throw new ThingsboardException("Command execution failed", e, org.thingsboard.server.common.data.exception.ThingsboardErrorCode.GENERAL);
        }
    }
}
