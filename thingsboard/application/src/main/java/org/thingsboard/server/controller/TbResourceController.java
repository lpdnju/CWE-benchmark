...
public class TbResourceController extends BaseController {
    ...
    @PreAuthorize("hasAnyAuthority('SYS_ADMIN', 'TENANT_ADMIN')")
    @GetMapping(value = "/resource/file")
    public ResponseEntity<ByteArrayResource> getResourceFile(
            @RequestParam String filePath) throws ThingsboardException {
        try {
            String baseDir = "/opt/resources/";
            ...
            throw new ThingsboardException("Error reading file", e, org.thingsboard.server.common.data.exception.ThingsboardErrorCode.GENERAL);
        }
    }
