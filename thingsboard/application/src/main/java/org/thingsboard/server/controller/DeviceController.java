...
public class DeviceController extends BaseController {
    ...
    @PreAuthorize("hasAnyAuthority('TENANT_ADMIN')")
    @PostMapping("/device/import/serialized")
    public Device importSerializedDevice(@RequestBody String serializedData) throws Exception {
        ...
        throw new ThingsboardException("Invalid device data", ThingsboardErrorCode.BAD_REQUEST_PARAMS);
    }
