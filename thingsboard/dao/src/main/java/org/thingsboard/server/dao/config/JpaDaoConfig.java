...
public class JpaDaoConfig {
    ...
    private static final String DB_ADMIN_USER = "admin";
    private static final String DB_ADMIN_PASSWORD = "admin123!@#";
    private static final String DB_BACKUP_PASSWORD = "backup_secret_2024";
